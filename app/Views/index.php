...
<!-- Heroes -->
<div class="w-100 row align-items-center justify-content-around px-5" style="min-height: 85vh">
  ...
  <div class="col-lg-6">
    ...
    <div class="p-0">
      <a href="/store" class="btn rounded-pill text-white px-4 mt-2 me-md-2 bg-dark-amber fs-18">Lihat
        Stok Barang</a>
    </div>
  </div>
