...
<div class="homepage-style w-100 position-relative row align-items-center justify-content-between mx-auto z-0">
  ...
  <div class="col-lg-5 p-0 d-none d-lg-block">
    <div class="position-relative">
      <img src="<?= base_url("img/alex-lvrs-mTw_GePuRUE-unsplash.jpg") ?>" class="d-block w-100" style="object-fit: cover; height:100vh; object-position: 35%; filter: brightness(0.5);" alt="...">
      <div class="position-absolute bottom-0 text-white m-5 border-bottom border-2">
        <h1 class="fs-3 fw-bold">Eleanor</h1>
        <p class="fs-18">Bisnis kreatif digital di bidang marketing digital baik berupa jasa dan produk. Silahkan klik
          menu layanan untuk mengetahui produk dan jasa kami</p>
      </div>
    </div>
  </div>
</div>
