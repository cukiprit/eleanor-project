...
<div class="p-4 px-lg-5 d-flex flex-column justify-content-center" style="min-height: 100vh;background-color: #fef3c7;">
  ...
  <div class="row flex-column flex-lg-row w-fit mx-auto rounded bg-white shadow">
    <div class="col-auto col-lg-4 p-4 m-2 bg-dark-amber rounded text-white">
    ...
    <div class="col-auto col-lg-7 mx-auto p-4">
