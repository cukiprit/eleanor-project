...
<div class="px-5" style="min-height: 100vh;background: linear-gradient(0deg, #fff 19%, #fef3c7 99%); padding-top: 6rem;">
  ...
  <div class="row w-fit mx-auto rounded bg-white shadow">
    <div class="col-4 p-4 m-2 bg-primary rounded text-white">
